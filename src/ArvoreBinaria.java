...
public class ArvoreBinaria {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arvore.retornaListaEncadeada());
    }
    ...
    public LinkedList<Integer> retornaListaEncadeada() {
        return retornaListaEncadeada(raiz);
    }

    private LinkedList<Integer> retornaListaEncadeada(Nodo raiz) {
        ...
        for (Integer dado : retornaListaEncadeada(raiz.esquerdo)) {
            lista.add(dado);
        }

        lista.add(raiz.dado);

        for (Integer dado : retornaListaEncadeada(raiz.direito)) {
            lista.add(dado);
        }
